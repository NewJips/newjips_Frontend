...
// 상세 페이지로 이동하는 함수
const goToEstateDetail = (index) => {
  const eno = enoList[index] || 0;
  router.push(`/estate/${eno}`);
};
