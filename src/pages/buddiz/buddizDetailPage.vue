<template>
  <div class="fluid-container">
    <div class="type-header mb-4">
      ...
      <div style="font-size: 17pt; margin-top: 8pt">
        {{ t('common.budi.content') }}
      </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="card border-0 shadow mb-6 mb-lg-0">
              <div class="card-header bg-gray-100 py-4 border-0 text-center">
                <a class="d-inline-block" href="#">
                  <img
                    :src="buddiz.profilePic"
                    alt="buddiz image"
                    class="d-block avatar avatar-xxl p-1 mb-2"
              ...
              <div class="card-body p-4">
                <div class="test">
                  ...
                  >
                    <img
                      src="/src/assets/icons/roundstar.png"
                      alt="star"
                ...
                <div class="test" style="margin-top: 20px">
                  ...
                  >
                    <img
                      src="/src/assets/icons/roundmoney.png"
                      alt="money"
                      style="width: 35px; height: 35px"
                    />
                  ...
                  <div class="text-block">
                    ...
                    <form @submit.prevent="wishSubmit" class="mt-3">
                      <div>
                        <button
                          ...
                          class="badge2"
                          :class="{
                            'badge-secondary-light2': !isLiked,
                            active: isLiked,
                          }"
                    ...
                    <form @submit.prevent="makeChating">
                      <div>
                        <button
                          type="submit"
                          class="badge2 badge-secondary-light2"
                          style="width: 260px; font-size: 15px; border: none"
                        >
                          <img
                            src="/src/assets/icons/chatIcon.png"
                            alt="star"
                            height="20px"
                            class="me-2"
                          />
          ...
          <div class="col-lg-9 ps-lg-5 mt-2">
            ...
            <div class="text-block">
              <p>
                <span
                  ...
                  >{{ t('common.budi.lived') }} {{ buddiz.liveInKr
                  }}{{ t('common.budi.years') }}</span
                >
                <span
                  style="margin-right: 7px"
                  class="badge badge-secondary-light"
                  >{{ t('common.budi.active') }} {{ buddiz.hiredTimes
                  }}{{ t('common.budi.count') }}</span
                >
                <span
                  style="margin-right: 7px"
                  class="badge badge-secondary-light"
            ...
            <div class="d-flex align-items-center justify-content-between mb-1">
              <h3 class="subtitle text-sm text-primary">
                {{ t('common.budi.review') }}
              </h3>
              <button
                ...
                <form @submit.prevent="submit" class="form" id="contact-form">
                  ...
                  <div class="mb-4">
                    <label class="form-label" for="article">{{
                      t('common.budi.reviewContent')
                    }}</label>
                    <textarea
                      class="form-control"
                      v-model="article.reviewContent"
                      rows="4"
                      id="article"
                      :placeholder="t('common.budi.reviewPH')"
                      required
                    ></textarea>
                  </div>
                  <button
            ...
            <div v-if="reviewList.length > 0">
              <div
                ...
                :key="review.id"
                class="d-flex d-block d-sm-flex review"
                style="padding: 15px 0 15px 0; border-bottom: 1.5px solid #ddd"
              >
                <div
                  class="flex align-items-center text-md-center flex-shrink-0 me-2 ms-2 ms-xl-4 me-xl-4"
                >
                ...
                <div>
                  ...
                  <div class="mb-2">
                    <i
                      ...
                      :key="star"
                      class="fa fa-xs fa-star text-primary"
                    ></i>
                    <i
                      v-for="emptyStar in 5 - review.rating"
                      :key="emptyStar"
                      class="fa fa-xs fa-star text-gray-200"
                    ></i>
                  </div>
